package com.amer.service.controller;

import com.amer.service.dal.dao.GuestRepository;
import com.amer.service.dal.model.Guest;
import com.amer.service.dal.model.GuestModel;
import com.amer.service.exceptions.GuestNotFoundException;
...
//    }
    ...
    public ResponseEntity<Guest> addGuest(@RequestBody GuestModel model){
        ...
        URI location = ServletUriComponentsBuilder.fromCurrentRequest().path("/{id}").buildAndExpand(guest.getGuestId()).toUri();
